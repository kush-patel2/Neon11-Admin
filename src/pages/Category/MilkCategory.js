...
import {
  ...
  removeMilkCategory,
  updateMilkCategory,
} from "../../functions/Category/MilkCategory";
...
const MilkCategory = () => {
  ...
  const { milkType, Category, IsActive } = values;
  ...
  const validate = (values) => {
    ...
    if (values.milkType === "") {
      errors.milkType = "Milk Type is required!";
      setErrTP(true);
    }
    if (values.milkType !== "") {
      setErrTP(false);
  ...
  const fetchCategories = async () => {
    ...
    await axios
      .post(
        `${process.env.REACT_APP_API_URL_COFFEE}/api/auth/list-by-params/milk-category`,
        {
          skip: skip,
          per_page: perPage,
          sorton: column,
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <BreadCrumb
            maintitle="Milk Category"
            title="Products Category"
            pageTitle="Milk Category"
          />
          <Row>
            <Col lg={12}>
              <Card>
        ...
        <form>
          <ModalBody>
            ...
            <div className="form-floating mb-3">
              ...
              {isSubmit && <p className="text-danger">{formErrors.milkType}</p>}
            </div>
