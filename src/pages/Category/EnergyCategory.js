...
import {
  ...
  removeEnergyMaster,
  updateEnergyMaster,
} from "../../functions/Category/EnergyCategory";
...
const EnergyCategory = () => {
  ...
  const { energyType, Category, IsActive } = values;
  ...
  const [EnergyCategory, setEnergyCategories] = useState([]);
  ...
  const validate = (values) => {
    ...
    if (values.energyType === "") {
      errors.energyType = "Energy Type is required!";
      setErrTP(true);
    }
    if (values.energyType !== "") {
      setErrTP(false);
  ...
  const fetchCategories = async () => {
    ...
    await axios
      .post(
        `${process.env.REACT_APP_API_URL_COFFEE}/api/auth/list-by-params/energy-category`,
        {
          skip: skip,
          per_page: perPage,
          sorton: column,
  ...
  const col = [
    ...
    {
      name: "Energy Drink Type",
      selector: (row) => row.energyType,
      sortable: true,
      sortField: "energyType",
      minWidth: "150px",
    },
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <BreadCrumb
            maintitle="Energy Drink Category"
            title="Products Category"
            pageTitle="Energy Drink Category"
          />
          <Row>
            <Col lg={12}>
              <Card>
        ...
        <form>
          <ModalBody>
            ...
            <div className="form-floating mb-3">
              ...
              />
              <Label>
                Energy Drink Type <span className="text-danger">*</span>
              </Label>
              {isSubmit && (
                <p className="text-danger">{formErrors.energyType}</p>
              )}
            </div>
