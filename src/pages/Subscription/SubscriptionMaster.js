...
const SubscriptionMaster = () => {
  ...
  const { title, savePercentage, IsActive } = values;
  ...
  const handleClick = (e) => {
    ...
    createSubscriptionMaster(values)
      .then((res) => {
        setmodal_list(!modal_list);
        setValues(initialState);
        setIsSubmit(false);
  ...
  const handleDelete = (e) => {
    e.preventDefault();
    removeSubscriptionMaster(remove_id)
      .then((res) => {
        setmodal_delete(!modal_delete);
        fetchCategories();
      })
  ...
  const handleUpdate = (e) => {
    ...
    updateSubscriptionMaster(_id, values)
      .then((res) => {
        setmodal_edit(!modal_edit);
        fetchCategories();
      })
  ...
  document.title = "Subscription Master | RC Henning Coffee Company";
