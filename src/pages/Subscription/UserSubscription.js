...
import { removeUserSubscription } from "../../functions/Subscription/UserSubscription";
...
const UserSubscription = () => {
  ...
  const handleDelete = (e) => {
    e.preventDefault();
    removeUserSubscription(remove_id)
      .then((res) => {
  ...
  document.title = "User Subscriptions | RC Henning Coffee Company";
  return (
    <React.Fragment>
      <UiContent />
